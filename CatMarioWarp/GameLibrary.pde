...
abstract class Actor extends Positionable {
   ...
   */
  public void draw(float vx, float vy, float vw, float vh) {
...
class Boundary extends Positionable {
   ...
   */
  void enable() { disabled = false; print("HI");}

  /**
   * Disable this boundary
   */
  void disable() { disabled = true; print("BYE");}
   ...
   */
  public String toString() { return x+","+y+","+xw+","+yh; }
}
/**
 ...
 */
public abstract class BoundedInteractor extends Interactor implements BoundaryCollisionListener {
   ...
   */
  public abstract void collisionOccured(Boundary boundary, Actor actor, float[] intersectionInformation);
...
// -- draw methods
  ...
  // pass-through/unused
  public void draw(float _a, float _b, float _c, float _d) {
    this.draw();
  }
...
// Tien object
// can walk and jump
public class Tien extends Player {
  Tien() {
    super("Tien");
    setStates();
    handleKey('W');
  ...
  void setStates() {
    addState(new State("standing", "SmallTien2.JPG"));
  }
